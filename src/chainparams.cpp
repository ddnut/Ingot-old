...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04cc76ef447102f39f019b0e59c08e380623cea08d7bd334792a1dd34b1b8ea1051b91d41c9fccc5121530516e9473ebc234635eae4bd38413c442979826d1ada7");
        nDefaultPort = 5556;
        nRPCPort = 6666;
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Deutsche Ingot";
        CTransaction txNew;
        ...
        // TX Comment
        txNew.strTxComment = "text:Ingot genesis block";
        ...
        vSeeds.push_back(CDNSSeedData("deutsche-ingot.org", "seed.deutsche-ingot.org"));
